...
public class TermBaseXMLParser {
    private int termSize = 4; // максимальное количество терминов одного языка
    ...
    private void setEntryList() {
        ...
        for (Element e: elements) {
            ...
            List<Element> languageGroups = e.getElementsByTag("languageGrp");
                ...
                // Поэтому сначала ищем все элементы term в первом languageGrp, это будут термины оригинального языка
